...
import com.lwj.canon.shutter.basefloat.AnimRevealFloatView;
import com.lwj.canon.shutter.basefloat.FloatPermissionDetectView;
import com.lwj.canon.shutter.basefloat.FloatWindowParamManager;
import com.lwj.canon.shutter.basefloat.FollowTouchView;
import com.lwj.canon.shutter.basefloat.FullScreenTouchAbleFloatWindow;
import com.lwj.canon.shutter.basefloat.FullScreenTouchDisableFloatWindow;
import com.lwj.canon.shutter.basefloat.InputWindow;
import com.lwj.canon.shutter.basefloat.NotFullScreenTouchDisableFloatWindow;
...
public class FloatWindowService extends Service {
    ...
    private final Handler mHandler = new Handler(Looper.getMainLooper()) {
        ...
        public void handleMessage(Message msg) {
            int what = msg.what;
            if (what == HANDLER_DETECT_PERMISSION) {
    ...
    private void addForegroundNotification() {
        ...
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(getApplicationContext(), NOTIFICATION_CHANNEL_ID)
                .setSmallIcon(R.drawable.apk40)
                .setLargeIcon(((BitmapDrawable) getResources().getDrawable(R.drawable.shutter)).getBitmap())
                .setContentTitle("CannonShutter")
                .setContentText("快门助手怎正在运行")
